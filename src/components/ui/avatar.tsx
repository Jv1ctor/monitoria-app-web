...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "group/avatar relative flex size-10 shrink-0 rounded-full bg-muted/40 ring-1 ring-border select-none data-[size=lg]:size-12 data-[size=sm]:size-8",
        className,
      )}
      {...props}
    />
...
function AvatarBadge({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      ...
      className={cn(
        "absolute right-0 bottom-0 z-10 inline-flex items-center justify-center rounded-full bg-success text-white ring-2 ring-background select-none",
