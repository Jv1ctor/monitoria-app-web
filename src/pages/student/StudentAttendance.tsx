...
export function StudentAttendancePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-10 px-6 w-full">
      <div className="mb-10">
        <h1 className="text-3xl font-bold text-foreground tracking-tight mb-2">Minhas Frequências</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <Card className="shadow-sm border-t-4 border-t-slate-400">
          <CardContent className="p-6">
            <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">Sessões registradas</p>
            <h2 className="text-4xl font-bold text-slate-800">{totalSessions}</h2>
          </CardContent>
        </Card>

        <Card className="shadow-sm border-t-4 border-t-green-500">
          <CardContent className="p-6">
            <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">Presenças</p>
            <h2 className="text-4xl font-bold text-green-600">{totalPresences}</h2>
          </CardContent>
        </Card>

        <Card className="shadow-sm border-t-4 border-t-[#0047BA]">
          <CardContent className="p-6">
            <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">Taxa de presença</p>
            <h2 className="text-4xl font-bold text-[#0047BA]">{attendanceRate}%</h2>
          </CardContent>
        </Card>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b bg-slate-50/50">
                <th className="px-6 py-4 text-[11px] font-bold text-muted-foreground uppercase tracking-widest">Data</th>
                <th className="px-6 py-4 text-[11px] font-bold text-muted-foreground uppercase tracking-widest">Horário</th>
                <th className="px-6 py-4 text-[11px] font-bold text-muted-foreground uppercase tracking-widest">Disciplina</th>
                <th className="px-6 py-4 text-[11px] font-bold text-muted-foreground uppercase tracking-widest">Monitor</th>
                <th className="px-6 py-4 text-[11px] font-bold text-muted-foreground uppercase tracking-widest text-right">Status</th>
              </tr>
            </thead>
